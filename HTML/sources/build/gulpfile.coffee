...
plugins  = [ 'jquery', 'jquery.cookie', 'cluster', 'lazyload', 'bootstrap', 'ScrollToFixed', 'easyzoom', 'count', 'browser', 'fotorama', 'isotope', 'cookie', 'bem', 'chosen', 'datepicker', 'spin', 'iCheck', 'velocity', 'parsley', 'photoswipe', 'hoverIntent', 'rangeSlider', 'likes', 'history', 'mask' ]
