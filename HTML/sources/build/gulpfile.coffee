...
plugins  = [ 'jquery', 'jquery.cookie', 'cluster', 'lazyload', 'bootstrap', 'easyzoom', 'browser', 'fotorama', 'isotope', 'cookie', 'bem', 'chosen', 'spin', 'iCheck', 'velocity', 'parsley', 'photoswipe', 'hoverIntent', 'rangeSlider', 'likes', 'history' ]
