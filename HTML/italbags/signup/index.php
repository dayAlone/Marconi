...
<div class="container textpage__content">
	...
	<div class="register">
		<div class="register__success hidden xxl-padding-top center">
			<p class="highlight">
				Ваш профиль зарегистрирован, но не активирован. Активация профиля происходит после предоставления пакета документов, а также проверки всех данных. Ознакомиться с необходимым списком документов, необходимых для начала работы, вы можете в разделе “<a href="/conditions/opt/">Условия работы</a>”. После активации профиля вы получите уведомление на e-mail, который указали при регистрации.
			</p>
			<p class="highlight">
