      ...
      <div class="row">
	    ...
	    <?else:?>
	        ...
	        <div class="col-xs-2 col-md-1">
	          ...
	          <input value="<?=$item['QUANTITY']?>" class="basket__count <?if(SITE_ID == 's2' && $item['CATALOG']['PROPERTIES']['SHOWCASE']['VALUE'] == "Y"):?>hidden<?endif;?>" data-id="<?=$item['ID']?>" data-price="<?=$item['PRICE']?>">
