...
foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	{
		case "PASSWORD":
			?><input size="30" type="password" id="password" <?=($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"?"required":"")?> name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input" /><?
			break;
		case "CONFIRM_PASSWORD":
			?><input size="30" type="password" data-parsley-equalto="#password" <?=($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"?"required":"")?> name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" /><?
			break;
		case "EMAIL":
