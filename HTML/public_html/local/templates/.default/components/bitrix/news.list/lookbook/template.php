...
<?foreach ($arResult['ITEMS'] as $key=>$item):
    ?>
      <div class="lookbook__slider-item">
        <div style="background-image: url(<?=$item['PREVIEW_PICTURE']['SRC']?>)" class="lookbook__picture <?=($item['PREVIEW_PICTURE']['HEIGHT'] > $item['PREVIEW_PICTURE']['WIDTH']?"lookbook__picture--contain":"")?>" data-height="<?=$item['PREVIEW_PICTURE']['HEIGHT']?>"></div>
