	    ...
	    <div class="row">
	      ...
	      <div class="col-sm-6 col-md-12 col-lg-6">
	        ...
	        <?if(SITE_ID == 's1' || isUserAccept()):
				...
				if(SITE_ID == 's2' || $props['SALE']['VALUE']=="77ebb502-85d4-11e4-82e4-0025908101de") $showRetailPrice = false;
				if (strlen($arResult['PROPERTIES']['SALE_TEXT']['VALUE']) > 0) $showRetailPrice = false;
			?>
		...
		<div class="modal-content">
			...
			<div class="modal-frame center" data-title="хочу в подарок">
				<p>
					...
					Поделитесь в любой социальной сети личным сообщением или у себя на стене, выбранным Вами аксессуаром.
				</p>
				<img src="http://<?=$_SERVER['SERVER_NAME']. $arResult['WATERMARK']?>" alt="" style='max-width: 60%'/>
				<br/>
