				...
				<div class="basket__block">
					...
					<? foreach ($arResult["DELIVERY"] as $key => $arDelivery):?>
						<input type="radio"
							...
							/>
	    				<label for="ID_DELIVERY_ID_<?= $arDelivery["ID"] ?>"><?=$arDelivery['TITLE']?> <?=($arDelivery["PRICE_FORMATED"]?$arDelivery["PRICE_FORMATED"]:"")?></label>
					<? endforeach; ?>
...
foreach ($arResult['ORDER_PROP']['USER_PROPS_N'] as $prop)
	$data['props'][] = array('id'=>$prop['FIELD_NAME'],'value'=>$prop["VALUE"]);
