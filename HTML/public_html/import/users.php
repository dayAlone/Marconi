	...
	class Users
	{
		...
		public function getData($raw)
		{
			...
			$fields = array(
				...
				'EMAIL'             => $raw['email'],
				'NAME'              => $raw['name'],
				'LAST_NAME'         => $raw['family'],
				'PASSWORD'          => $raw['password'],
				'CONFIRM_PASSWORD'  => $raw['password'],
				'GROUP_ID'          => $groups,
				'PERSONAL_GENDER'   => ($raw['sex']=='men'?"M":"F"),
				'PERSONAL_BIRTHDAY' => (strlen($raw['birthday']) > 1 && $raw['birthday'] != '0000-00-00'?date('d.m.Y', strtotime($raw['birthday'])):""),
				'PERSONAL_PHONE'    => $raw['phone_code'].$raw['phone_code'],
				'PERSONAL_MOBILE'   => $raw['s_phone_code'].$raw['s_phone'], // what's up
				'WORK_PHONE'        => $raw['m_phone_code'].$raw['m_phone'],
				'WORK_COMPANY'      => $raw['company'],
				'WORK_NOTES'        => $raw['company_address'],
				'PERSONAL_NOTES'    => $raw['company_info'],
